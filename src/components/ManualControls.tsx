...
const ManualControls = ({ 
  ...
  const handleParamChange = (name: keyof ManualProcessingParams, value: number) => {
    setParams(prev => {
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <Label htmlFor="compression">Compression ({params.compression})</Label>
            </div>
            <Slider 
              id="compression"
              min={0} 
              ...
              onValueChange={([value]) => handleParamChange('compression', value)}
              disabled={isProcessing}
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <Label htmlFor="lowpass">Low Pass ({params.lowpass ? params.lowpass + 'Hz' : 'Off'})</Label>
            </div>
            <Slider 
              id="lowpass"
              min={0} 
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <Label htmlFor="highpass">High Pass ({params.highpass ? params.highpass + 'Hz' : 'Off'})</Label>
            </div>
            <Slider 
              id="highpass"
              min={0} 
