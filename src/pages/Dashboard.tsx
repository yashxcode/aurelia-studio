...
const Dashboard = () => {
  ...
  useEffect(() => {
    const loadAudioBuffer = async () => {
      ...
      try {
        // Load enhanced audio
        const { data: enhancedData, error: enhancedError } =
        ...
        const enhancedBuffer = await audioContextRef.current.decodeAudioData(
          enhancedArrayBuffer
        )
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Enhanced with{" "}
                          {formatPresetName(selectedAudio.preset_used)} preset
                        </p>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() =>
                          handleDeleteAudio(selectedAudio?.id || "")
                        }
                    ...
                    <div className="mt-6">
                      <AudioPlayer
                        ...
                        processedAudioBuffer={
                          selectedAudio?.enhancedBuffer || null
                        }
          ...
          <div className="lg:col-span-2">
            <Card className="h-full">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  This is your personal audio library where all your enhanced
                  audio files are stored. You can play, compare, and download
                  your processed audio anytime.
                </p>
                <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
                  <li>Select any file to play it</li>
                  <li>Compare original and enhanced versions</li>
                  <li>
                    Download processed files for use in other applications
                  </li>
